<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:33:"./template/pc/lists_images_cp.htm";i:1653462652;s:42:"D:\phpstudy_pro\WWW\e\template\pc\head.htm";i:1653464046;s:43:"D:\phpstudy_pro\WWW\e\template\pc\right.htm";i:1653461210;s:44:"D:\phpstudy_pro\WWW\e\template\pc\footer.htm";i:1653449154;s:44:"D:\phpstudy_pro\WWW\e\template\pc\bottom.htm";i:1653449672;}*/ ?>
<!DOCTYPE html>
<head>
      ...
      <div class="module-inner">
        <div class="module-content">
          <div class="responsive-carousel carousel clearfix">
            <div id="responsive-247870">
              <div class="carousel-item">
                <div class="carousel-img"><a href="javascript:;"><img src="<?php echo gettoptype($eyou['field']['typeid'],'litpic'); ?>" alt="<?php echo $eyou['field']['typename']; ?>"/></a></div>
              </div>
            </div>
            <div class="carousel-btn carousel-btn-fixed" id="carousel-page-247870"></div>
            <script type="text/javascript">
     
  $(window).load(function(){
   $("#responsive-247870").carouFredSel({
    responsive : true,
    width       : '100%',
    items  : { visible : 1 },
    auto     : { pauseOnHover: true, timeoutDuration:5000 },
    swipe     : { onTouch:true, onMouse:true },
    pagination  : "#carousel-page-247870"
   });
   $("#responsive-247870 .carousel-item").show();
  });
</script></div>
        </div>
      </div>
      ...
      <section class="content float-left">
        <div class="content-wrapper">
          <div class="module">
            <div class="module-inner">
              <div class="module-content">
                <div class="product-filter"> <?php  $tagScreening = new \think\template\taglib\eyou\TagScreening; $_result = $tagScreening->getScreening("current", "", "", "不限", "");if(!empty($_result["list"]) || (($_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator ) && $_result["list"]->isEmpty())): $field = $_result; if(is_array($field['list']) || $field['list'] instanceof \think\Collection || $field['list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                  <dl class="dl-horizontal clearfix">
                    <dt><strong><?php echo $vo['title']; ?></strong>：</dt>
                    <dd> <?php if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$val): $i= intval($key) + 1;$mod = ($i % 2 ); ?> <a <?php echo $val['onClick']; ?> class="<?php echo $val['currentstyle']; ?>"><?php echo $val['name']; ?></a>&nbsp;
                      <?php echo isset($val["ey_1563185380"])?$val["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($val["ey_1563185376"]))?$val["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $val = []; ?> </dd>
                  </dl>
                  ...
                  <div class="entry-item">
                    <div class="typo">
                      ...
                      <div class="typo-text">
                        ...
                        <div class="price"><strong>￥<span><?php echo $field['jiage']; ?></span></strong></div>
    ...
    <div class="module module-hlbg">
      <div class="module-inner">
        ...
        <div class="module-hlbg-content">
          <div class="qhd-content">
            <p style="text-align: center; margin:15px 0 20px;"> <span style="font-size:16px;">让1对1旅行管家为你定制</span></p>
            <p style="text-align: center;"> <span style="color: rgb(51, 51, 51); font-family: 'Microsoft YaHei'; line-height: 21px; background-color: rgb(238, 246, 242);"><a class="btn-large btn-large-main" href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_4"); echo $__VALUE__; ?>&amp;site=qq&amp;menu=yes"><span>联系客服</span></a></span></p>
            <hr />
            <p style="text-align: center;"> <span style="color:#2ba165;">关注我社微信<br />
              <span style="line-height: 1.8;">&nbsp;<strong>领现金优惠！</strong></span></span></p>
            <p style="text-align: center;"> <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_attr_12"); echo $__VALUE__; ?>" style="width: 150px; height: 150px;" /></p>
          </div>
        </div>
      </div>
    </div>
