<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:45:"./application/admin/template/images\index.htm";i:1678325226;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\layout.htm";i:1648202588;s:69:"D:\phpstudy_pro\WWW\e\application\admin\template\public\theme_css.htm";i:1678325226;s:64:"D:\phpstudy_pro\WWW\e\application\admin\template\article\bar.htm";i:1678325224;s:70:"D:\phpstudy_pro\WWW\e\application\admin\template\archives\tags_btn.htm";i:1678325224;s:70:"D:\phpstudy_pro\WWW\e\application\admin\template\archives\flag_btn.htm";i:1622084942;s:64:"D:\phpstudy_pro\WWW\e\application\admin\template\public\page.htm";i:1678325226;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <script type="text/javascript">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div class="w120 tc ellipsis"><a href="<?php echo url('Images/index', array('typeid'=>$vo['typeid'], 'tab'=>3)); ?>" title="<?php echo $vo['typename']; ?>"><?php echo (isset($vo['typename']) && ($vo['typename'] !== '')?$vo['typename']:'<i class="red">数据出错！</i>'); ?></a></div>
                            </td>
                            <td align="center" class="">
                                <div class="tc w50">
                                    <?php if($vo['arcrank'] == -1): ?>
                            ...
                            <td class="operation">
                                <div class="w160 tc">
                                    ...
                                    <a href="<?php echo url('Images/edit',array('id'=>$vo['aid'])); ?>" class="btn blue">编辑</a>
                                    <i></i>
                                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                                    <a class="btn red"  href="javascript:void(0);" data-url="<?php echo url('Images/del'); ?>" data-id="<?php echo $vo['aid']; ?>" <?php if($recycle_switch == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?> onClick="delfun(this);">删除</a>
                                    <i></i>
                                    <?php endif; ?>
                                    <a href="<?php echo $vo['arcurl']; ?>" class="btn blue" target="_blank">浏览</a>
                                </div>
                            </td>
                            <td class="sort">
                                <div class="w60 tc">
        ...
        <div class="footer-oper">
            ...
            <div class="nav-dropup">
                ...
                <div class="dropdown-menus" style="display:none; <?php if(0 < $pager->totalRows && ($pager->totalRows < 3 || $pager->listRows < 3)): ?>top:28px;bottom:unset;border-bottom:1px solid rgba(0,0,0,.15);border-top:none;min-height: 250px;<?php endif; ?>">
                    ...
                    <?php endif; if(is_check_access(CONTROLLER_NAME.'@del') == '1'): ?>
                    <a href="javascript:void(0);" onclick="batch_del(this, 'ids');" data-url="<?php echo url('Images/del'); ?>" <?php if($recycle_switch == '1'): ?> data-deltype="del" <?php else: ?> data-deltype="pseudo" <?php endif; ?>>删除文档</a>
