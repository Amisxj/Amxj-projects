<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/article\add.htm";i:1678325224;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\layout.htm";i:1648202588;s:69:"D:\phpstudy_pro\WWW\e\application\admin\template\public\theme_css.htm";i:1678325226;s:84:"D:\phpstudy_pro\WWW\e\application\admin\template\archives\get_field_addonextitem.htm";i:1678325224;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="<?php if(empty($channelRow['data']['is_article_pay'])): ?> none <?php endif; ?>">
                <dl class="row">
                    ...
                    <dd class="opt">
                        ...
                        <label class="curpoin"><input type="radio" name="restric_type" value="2">会员专享</label>&nbsp;&nbsp;
    ...
    function showEditor_1597892187(elemtid) {
        ...
        <div class="ncap-form-default tab_div_3" style="display:none;">
            ...
            <dl class="row <?php if(!in_array(($seo_pseudo), explode(',',"2"))): ?>no-grey<?php endif; ?>" >
                ...
                <dd class="opt">
                    <input type="text" <?php if(!in_array(($seo_pseudo), explode(',',"2"))): ?>readonly="readonly" title="仅在静态模式下使用"<?php endif; ?> value="" name="htmlfilename" id="htmlfilename" autocomplete="off" onkeyup="this.value=this.value.replace(/[^\w\-]/g,'-');" onpaste="this.value=this.value.replace(/[^\w\-]/g,'-');" class="input-txt <?php if(!in_array(($seo_pseudo), explode(',',"2"))): ?>no-drop<?php endif; ?>">.html
                    <span class="err"></span>
                </dd>
            </dl>
        </div>
