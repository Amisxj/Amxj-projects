<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:58:"./application/admin/template/recycle_bin\arctype_index.htm";i:1678325226;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\layout.htm";i:1648202588;s:69:"D:\phpstudy_pro\WWW\e\application\admin\template\public\theme_css.htm";i:1678325226;s:68:"D:\phpstudy_pro\WWW\e\application\admin\template\recycle_bin\bar.htm";i:1678325226;s:64:"D:\phpstudy_pro\WWW\e\application\admin\template\public\page.htm";i:1678325226;s:66:"D:\phpstudy_pro\WWW\e\application\admin\template\public\footer.htm";i:1571728724;}*/ ?>
<!doctype html>
<html>
<head>
...
//            $("#bodystyle").css("padding"," 15px 0px");
    ...
    function recovery(obj){
        layer.confirm('确认还原？如有父级栏目及文档将一起还原。', {
            shade: layer_shade,
            area: ['480px', '190px'],
            move: false,
            title: '提示',
    ...
    function batch_recovery(obj, name) {
        ...
        // 还原按钮
        layer.confirm('确认批量还原？如有父级栏目及文档将一起还原。', {
            shade: layer_shade,
            area: ['480px', '190px'],
            move: false,
            title: '提示',
    ...
    // 删除
    function delfun(obj){
        layer.confirm('确认彻底删除？如有子栏目及文档将一起清空。', {
            shade: layer_shade,
            area: ['480px', '190px'],
            move: false,
            title: '提示',
