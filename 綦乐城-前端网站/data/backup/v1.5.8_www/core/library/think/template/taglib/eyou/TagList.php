...
class TagList extends Base
{
    ...
    public function getList($param = array(), $pagesize = 10, $orderby = '', $addfields = '', $ordermode = '', $thumb = '', $arcrank = '')
    {
        ...
        $cacheKey = 'taglib-'.md5(__CLASS__.__FUNCTION__.json_encode([$param,$pagesize,$orderby,$addfields,$ordermode,$thumb,$arcrank,$this->tid,self::$main_lang,self::$home_lang,self::$city_switch_on,self::$site_info,$web_stypeid_open]));
...
/*                    if (empty($val['litpic'])) {
    ...
    public function getSearchList($pagesize = 10, $orderby = '', $addfields = '', $ordermode = '', $thumb = '', $arcrank = '')
    {
        ...
        $search_model = 'default'; // 检索标题/智能检索（标题+seo关键词）
