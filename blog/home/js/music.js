...
let type = "K"; //song: 单曲; playlist: 歌单; album: 唱片
let id = "9459909341"; //封面 ID / 单曲 ID / 歌单 ID 7452421335

$.ajax({
    url: "https://api.wuenci.com/meting/api/?server=" + server + "&type=" + type + "&id=" + id,
    //  url: "https://api.wuenci.com/meting/api/?type=https://i.y.qq.com/n2/m/share/details/taoge.html?platform=11&appshare=android_qq&appversion=14030008&hosteuin=oi-kowSP7Koion**&id=9459909341&ADTAG=wxfshare",
    type: "GET",
    dataType: "JSON",
