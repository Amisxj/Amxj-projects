...
public class CCourseMarkStatistic extends JDialog {
	...
	public void flashData(){
		...
		if(totalCounts==0)
			return;
		jLabel_course_good.setText(Integer.parseInt(course_goodRadio.get(1))/totalCounts+"%");
		jLabel_course_ok.setText(Integer.parseInt(course_goodRadio.get(2))/totalCounts+"%");
